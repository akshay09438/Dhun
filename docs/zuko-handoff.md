...
(none yet - this repo was just bootstrapped)

## In flight

Nothing in flight. The harness is installed and the repo is ready for work.

## Do first next session

Run `/start`, then describe the change you want in one line and let `/build` classify it.
